          ...
          <div className="flex flex-col md:flex-row gap-8">
            <div className="md:w-1/2">
              ...
              <p className="text-gray-700 mb-4 leading-relaxed">
                Nestled in the Western Ghats, Wayanad is one of the most
                beautiful districts in Kerala, known for its mist-clad
                mountains, lush green forests, and rich biodiversity. The name
                'Wayanad' comes from 'Vayal Nadu' which means 'Land of Paddy
                Fields' in Malayalam.
              </p>
              <p className="text-gray-700 mb-6 leading-relaxed">
                With altitudes ranging from 700 to 2100 meters above sea level,
                Wayanad enjoys a pleasant climate throughout the year. It's home
                to several indigenous tribes and offers a perfect blend of
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-emerald-900 to-emerald-950 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl mb-8">
            Book your stay at Wayanadan Huts for an authentic experience
          </p>
          <Link to="/">
